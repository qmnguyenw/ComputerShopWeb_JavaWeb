...
<%-- 
    Document   : productadd
    Created on : Jun 17, 2019, 9:16:07 PM
    Author     : Quang Nguyen
--%>
    ...
    <body>
        ...
        <div class="section">
            ...
            <div class="container">
                <!-- row -->
                <div class="row">
                    <h2 style="font-family: Candara;text-align: center;color: red;">Create New Product</h2>
                        ...
                        <form action="productadd" method="post">
                            <div id="container">
                                <div id="text">
                                    ...
                                    <b class="textItem">CategoryID:</b> <br><br>
                                ...
                                <div id="enter">
                                    <input class="rec" type ="text" name="id" value="${id}" /> &nbsp;<span class="error">${idLabel}</span><br><br>
                                    <input class="rec" type ="text" name="name" value="${name}" /> &nbsp;<span class="error">${nameLabel}</span><br><br>
                                    <input class="rec" type ="text" name="categoryID" value="${categoryID}" /> &nbsp;<span class="error">${categoryIDLabel}</span><br><br>
                                    <input class="rec" type ="text" name="price" value="${price}" /> &nbsp;<span class="error">${priceLabel}</span><br><br>
                                    <input class="rec" type ="text" name="quantity" value="${quantity}" /> &nbsp;<span class="error">${quantityLabel}</span><br><br>
                                    <input class="rec" type ="text" name="describe" value="${describe}" /> &nbsp;<span class="error">${describeLabel}</span><br><br>
                                    <input class="rec" type ="date" name="adddate" value="${addDate}" /> &nbsp;<span class="error">${addDateLabel}</span><br><br>
                                    <div>
                                        <p><span style="color: red">*Note:</span> <i>CategoryID only can choose from following table.</i></p>
