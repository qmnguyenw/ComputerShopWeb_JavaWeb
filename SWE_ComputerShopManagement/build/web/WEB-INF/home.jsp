<%-- 
    Document   : home
    Created on : Jul 17, 2019, 11:34:53 PM
    Author     : Quang Nguyen
--%>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <ul style="text-align: 10px; padding: 10px;">
                        <li><a href="productlist"><input type="button" value="Management Product" style="border-radius: 20px; border: 0; padding: 10px; margin: 5px;"></a></li>
                        <li><a href="account"><input type="button" value="Management Account" style="border-radius: 20px; border: 0; padding: 10px; margin: 5px;"></a></li>
                        <li><a href="viewAction"><input type="button" value="View System Action" style="border-radius: 20px; border: 0; padding: 10px; margin: 5px;"></a></li>
                        <li><a href='signout'><input type="button" value="Signout" style="border-radius: 20px; border: 0; padding: 10px; margin: 5px;"></a></li>
                    </ul>
                </div>
            </div>
        </div>
